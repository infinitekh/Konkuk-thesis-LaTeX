% \title{Konkuk University Thesis Template}
...
\documentclass[a4paper,11pt,leqno,openbib,draft]{memoir} %add 'draft' to turn draft option on (see below)
%
%
% Adding metadata:
\usepackage{kotex}
